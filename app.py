...
print(scheduler.schedule_meeting("Luffy", "2025-03-18", "10:00", "11:00"))
print(scheduler.check_available_slots("Luffy", "2025-04-15"))
print(scheduler.view_meetings("Luffy", "2025-03-17"))
print(scheduler.cancel_meeting("Luffy", "2025-03-18", "10:00", "11:00"))
print(scheduler.view_meetings("Luffy", "2025-03-18"))
